...
type NetworkConnection struct {
	...
	SecondaryIpAddress               string `xml:"SecondaryIpAddress,omitempty"`               // Secondary IP address associated with this NIC.
	...
	SecondaryIpAddressAllocationMode string `xml:"SecondaryIpAddressAllocationMode,omitempty"` // Secondary IP address allocation mode for the secondary IP address associated with this connection. One of: POOL (A static IP address is allocated automatically from a pool of addresses.), DHCP (The IP address is obtained from a DHCP service.), MANUAL (The IP address is assigned manually in the IpAddress element.), NONE (No IP addressing mode specified.)
